...
func (h *Handler) List(
	...
	response.SuccessWithMeta(
		c,
		http.StatusOK,
		"class sessions fetched successfully",
		paginatedData,
...
// @Produce      json
// @Security     BearerAuth
// @Param        request body      CreateClassSessionRequest  true  "Create Class Session Payload"
// @Success      201     {object}  response.SuccessResponse
// @Failure      400     {object}  response.ErrorResponse
// @Failure      401     {object}  response.ErrorResponse
// @Router       /class-sessions [post]
