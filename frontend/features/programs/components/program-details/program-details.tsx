...
export function ProgramDetails({ program }: ProgramDetailsProps) {
  const details = [
    ...
    { label: 'Program Name', value: program.programName },
    { label: 'Department', value: program.department },
    { label: 'Degree Type', value: program.degreeType },
    { label: 'Duration', value: `${program.durationValue} ${program.durationUnit.toLowerCase()}` },
    { label: 'Total Semesters', value: String(program.totalSemesters) },
  ];
