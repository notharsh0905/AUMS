...
export function SemesterDetails({ semester }: SemesterDetailsProps) {
  const details = [
    { label: 'Semester ID', value: semester.semesterId },
    { label: 'Semester Name', value: semester.semesterName },
    { label: 'Semester Number', value: String(semester.semesterNumber) },
    { label: 'Academic Year', value: semester.academicYear },
    { label: 'Start Date', value: semester.startDate },
    { label: 'End Date', value: semester.endDate },
  ];
