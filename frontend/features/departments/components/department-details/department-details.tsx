...
export function DepartmentDetails({ department }: DepartmentDetailsProps) {
  const details = [
    ...
    { label: 'Department Code', value: department.departmentCode },
    { label: 'Department Name', value: department.departmentName },
    { label: 'School / Institution', value: department.school },
    { label: 'Head of Department (HOD)', value: department.hod || 'N/A' },
    { label: 'Description', value: department.description || 'No description provided' },
  ];
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center gap-4 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-150 dark:border-zinc-800">
        <div className="h-12 w-12 rounded-full bg-zinc-900 text-white dark:bg-zinc-50 dark:text-zinc-950 flex items-center justify-center font-bold text-lg select-none">
          ...
          {department.departmentCode.charAt(0)}
        </div>
